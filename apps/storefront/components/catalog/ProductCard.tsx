    ...
    <article aria-labelledby={titleId}>
      <Card className="h-full">
        <div
          ...
          className="flex aspect-[4/3] items-center justify-center bg-[linear-gradient(135deg,var(--ui-color-primary,#1f2937),var(--ui-color-secondary,#e5e7eb))] p-6 text-center text-[var(--ui-color-primary-contrast,#ffffff)]"
        >
          <div>
        ...
        <div className="p-6">
          <p className="text-sm text-[var(--ui-color-muted-text,#4b5563)]">{product.category.name}</p>
          <h2 id={titleId} className="mt-2 text-xl font-bold text-[var(--ui-color-primary,#1f2937)]">
            {product.name}
          </h2>
